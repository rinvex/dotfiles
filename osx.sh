...
# Set standby delay to 24 hours (default is 3 hours or 10800)
...
sudo systemsetup -settimezone "Africa/Cairo" > /dev/null
...
# Finder: remove old trash items after 30 days
defaults write com.apple.finder FXRemoveOldTrashItems -bool true

# Finder: other sensible configurations
...
# Finder: arrange group view by kind
...
# Finder: open folders in tabs instead of new windows
...
# Decrease the animation speed when hiding/showing the Dock
...
# Other sensible dock configuration
...
# System Integrity Protection should be disabled through Recovery Mode first!
